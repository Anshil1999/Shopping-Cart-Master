    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_23_ngx_bootstrap__["a" /* CollapseModule */],
            ],
...
var AddProductComponent = /** @class */ (function () {
    ...
    AddProductComponent.prototype.processFile = function (imageInput) {
        var _this = this;
        var file = imageInput.files[0];
        var reader = new FileReader();
        reader.addEventListener('load', function (event) {
            _this.selectedFile = new ImageSnippet(event.target.result, file);
            _this.img = _this.selectedFile.file['name'];
            //console.log("tts",this.selectedFile.file);
            _this.authservice.uploadImage(_this.selectedFile.file).subscribe(function (res) {
            }, function (err) {
            });
        });
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.uploadImage = function (image) {
        ...
        return this.http.post('/users/image-upload/', formData).pipe(Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__["a" /* map */])((function (json) { return json.imageUrl; })));
    };
